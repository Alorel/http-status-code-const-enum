...
export declare const enum HttpStatusCode {
  ...
  /** Used by GoCardless to indicate that a given token or secret is invalid */
  INVALID_GO_CARDLESS_TOKEN = 498,
  ...
  NGINX_HTTP_REQUEST_SENT_TO_HTTPS_PORT = 497,
